...
from blog.views import contact_view,register,login,verify_user,send_reset_code_email,reset_password_with_code,update_profile,get_user_data,update_password,TranscriptCreateView,TranscriptListView,TranscriptDetail
...
urlpatterns = [
    ...
    path('api/transcript/create/', TranscriptCreateView.as_view(), name='transcript-create'),
     path('api/transcripts/', TranscriptListView.as_view(), name='transcript-list'),
     path('api/transcripts/<int:pk>/', TranscriptDetail.as_view(), name='transcript-detail'),
